...
## فحص البناء وإصلاح الأعطال
- لتنفيذ بناء إنتاجي وتشغيل فحوصات الأنواع والتصحيح الثابت استخدم `npm run build`.
- إذا ظهرت أخطاء بعد تحديثات الحزم، احذف مجلد `node_modules` وملف القفل ثم ثبّت من جديد.
- البناء الحالي ناجح على Next.js 14.2.4 مع TypeScript 5.5.3، لذا أي تعديل على الإصدارات يتطلب إعادة البناء للتحقق.
